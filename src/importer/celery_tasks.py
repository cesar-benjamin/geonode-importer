...
def import_resource(self, execution_id, /, handler_module_path, action, **kwargs):
    ...
    try:
        orchestrator.update_execution_request_status(
            ...
            step=gettext("importer.import_resource"),
    ...
    **kwargs,
    ...
    try:
        ...
        orchestrator.update_execution_request_status(
            ...
            step=gettext("importer.publish_resource"),
            celery_task_request=self.request,
        )
        _exec = orchestrator.get_execution_object(execution_id)
        _files = _exec.input_params.get("files")
    ...
    **kwargs,
    ...
    try:
        orchestrator.update_execution_request_status(
            ...
            step=gettext("importer.create_geonode_resource"),
            celery_task_request=self.request,
        )
        _exec = orchestrator.get_execution_object(execution_id)
...
def copy_geonode_resource(
    ...
    orchestrator.update_execution_request_status(
        ...
        step=gettext("importer.copy_geonode_resource"),
    )
...
def copy_dynamic_model(
    ...
    try:
        orchestrator.update_execution_request_status(
            ...
            step=gettext("importer.copy_dynamic_model"),
        )
        additional_kwargs = {}
...
def copy_geonode_data_table(
    ...
    try:
        orchestrator.update_execution_request_status(
            ...
            step=gettext("importer.copy_geonode_data_table"),
        )
...
def rollback(self, *args, **kwargs):
    ...
    orchestrator.update_execution_request_status(
        ...
        last_updated=timezone.now(),
        func_name="rollback",
        step=gettext("importer.rollback"),
        celery_task_request=self.request,
    )
